...
exigerAdmin();   // <-- verrou : la page est inaccessible sans role admin

// Quelques chiffres pour le tableau de bord
...
<body>
    ...
    <p>
        ...
        — <a href="/nolabel/logout.php">Déconnexion</a>
    </p>
    ...
    <h2>Gestion</h2>
    <ul>
        <li><a href="/nolabel/admin/produits.php">Produits</a></li>
        <li><a href="/nolabel/admin/commandes.php">Commandes</a></li>
    </ul>
</body>
</html>